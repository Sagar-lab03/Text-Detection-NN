...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\AI - ML Projects\TextDetection_using_NN_CV\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\AI - ML Projects\TextDetection_using_NN_CV\venv\Scripts\deactivate.nu'
